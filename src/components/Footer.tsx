    ...
    <footer className="bg-gray-900 text-white">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">РаботаПоиск</span>
            </div>
            <p className="text-gray-400 mb-4">
              Ваш надежный помощник в поиске работы и сотрудников.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/resumes" className="text-gray-400 hover:text-white transition-colors">
                  Резюме
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">info@rabotapoisk.ru</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-800 text-center text-gray-400">
          <p>© 2025 РаботаПоиск. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
